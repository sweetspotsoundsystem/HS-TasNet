...
TARGETS = {1075: "1b088636828189c3a47d467a12141e5deab4a572b786bf1e2ba645a6b521c408"}
...
def main():
    ...
    require(result["status"] == "training_audit_and_full14_complete"
            ...
            and review["best_research_checkpoint"] == result["checkpoint"], "Require the selected completed continuation")
    for path in (previous / "production-stage/execution.json", previous / "full14/execution.json",
                 PHASE / "m4-quadrature-candidates-quiet-native-stage-001/execution.json"):
        execution = read(path)
    ...
    quiet = read(PHASE / "m4-quadrature-candidates-quiet-native-001/analysis.json")
    ...
    for relative in ("quadrature-continuation-001/selection-review.json",
                     "m4-quadrature-candidates-quiet-native-001/plan.json",
                     "m4-quadrature-candidates-quiet-native-001/analysis.json",
                     "m4-quadrature-candidates-quiet-native-stage-001/command.json",
    ...
    out = PHASE / "historical-ola-resume-retirement-003"
    ...
    write(out / "intent.json", {"targets": targets, "preserved_bindings": bindings,
          ...
          "limitation": "The historical step-1075 optimizer/RNG snapshot will no longer be available for exact training restarts. Its separate inference checkpoint, journals and original receipts remain byte-identical."})
