...
def main():
    ...
    require(stage["schema"] == "latency58-cleanup-lr3e6-stage-v1"
    ...
    from research.direct.latency58_cleanup_lr3e6_checkpoint import (
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-cleanup-lr3e6-resource-result-v1", "status": "pass",
