...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-controlled-deployed-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "controlled_deployed_candidate", "Unsupported parallel evaluation")
