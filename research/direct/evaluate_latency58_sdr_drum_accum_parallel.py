...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-drum-accum-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "drum_accum_candidate", "Unsupported parallel evaluation")
