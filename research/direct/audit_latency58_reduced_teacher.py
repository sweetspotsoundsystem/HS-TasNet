...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-reduced-teacher-training-v1", "Unknown training plan")
    from research.direct.latency58_reduced_teacher_checkpoint import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "latency58-reduced-teacher-audit-v1", "status": "pass", "step": step,
              ...
              "teacher_weight": plan["teacher_weight"], "reduced_teacher_version": plan["reduced_teacher_version"],
