"""Unchanged full14 music scoring for saved temporal_attention inference checkpoints."""
...
def main():
    ...
    require(sha(args.plan) == args.plan_sha256, "Temporal-attention scoring plan changed")
    plan = read(args.plan)
    require(plan["schema"] == "latency58-temporal-attention-full14-plan-v1" and plan["track_indices"] == list(range(14))
    ...
    write(out / "result.json", {"schema": "latency58-temporal-attention-full14-result-v1", "status": "pass",
