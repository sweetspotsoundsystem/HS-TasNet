"""Score an audited hare_loss_ablation generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.hare_loss_ablation_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "hare-loss-ablation-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "hare_loss_ablation_trial_updates": receipt["step"], "provenance": model.provenance,
