...
def main():
    ...
    root = PHASE / "branch-long-context-005"
    ...
    for path in (root / "resource-stage/execution.json", root / "production-stage/execution.json",
                 ...
                 PHASE / "branch-long-context-preparation-stage-005/execution.json",
                 PHASE / "branch-long-context-preparation-stage-005/root-execution.json"):
        execution = read(path)
