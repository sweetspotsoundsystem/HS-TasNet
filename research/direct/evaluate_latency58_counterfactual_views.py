"""Score the same fixed vocal counterfactuals for a completed counterfactual pilot."""
...
def initialize_worker(plan):
    ...
    spec = plan["model"]
    require(spec["kind"] == "counterfactual", "Require the new counterfactual checkpoint family")
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-counterfactual-views-evaluation-plan-v1" and plan["workers"] == 2
