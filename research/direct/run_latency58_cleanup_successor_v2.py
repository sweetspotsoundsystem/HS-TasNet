...
from research.direct.latency58_cleanup_successor_checkpoint_v2 import load_parent, require_space, validate_recipe
...
def stage(plan_path, previous_execution, out):
    ...
    spec = {"schema": "gpu-watchdog-launch-v1", "cwd": str(ROOT), "environment": plan["environment"],
            ...
            "argv": [PYTHON, "-u", "-m", "research.direct.train_latency58_cleanup_successor_v2",
...
def main():
    ...
    resource_execution = stage(args.resource_plan, args.previous_execution, PHASE / "cleanup-successor-resource-002")
    ...
    execution = stage(path, resource_execution, PHASE / "cleanup-successor-to-000250-002")
    ...
    execute([PYTHON, "-u", "-m", "research.direct.audit_latency58_cleanup_successor_v2", "--plan", str(path),
