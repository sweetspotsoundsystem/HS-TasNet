"""Run the preserved bass probes through one hop128 checkpoint on CPU1.
...
def main():
    ...
    require(plan["schema"] == "latency58-teacher-probe-plan-v1"
    ...
    from research.direct.latency58_teacher_checkpoint import load_model_state, make_model
    ...
    report = {"schema": "latency58-asymmetric-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
