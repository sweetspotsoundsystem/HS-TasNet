...
def main():
    ...
    require(training["schema"] == "latency58-sdr-training-v1", "Require an SDR trial plan")
    ...
    paths = [audit_path, audit_exec_path, stage / "execution.json", stage / "stage.json", monitor_path,
             ...
             Path(__file__).resolve(), ROOT / "research/direct/evaluate_latency58_sdr.py",
             ROOT / "research/direct/compare_latency58_sdr.py", ROOT / "research/direct/compare.py"]
    if "probes" in args.modes:
        paths.append(ROOT / "research/direct/evaluate_latency58_sdr_probes.py")
    ...
    for mode in args.modes:
        ...
        plan.update(schema="latency58-sdr-" + ("probe" if mode == "probes" else "music") + "-plan-v1",
    ...
    for mode, out, plan in prepared:
        ...
        module = "research.direct.evaluate_latency58_sdr" + ("_probes" if mode == "probes" else "")
