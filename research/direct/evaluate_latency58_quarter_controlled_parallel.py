...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-quarter-controlled-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "quarter_controlled_candidate", "Unsupported parallel evaluation")
