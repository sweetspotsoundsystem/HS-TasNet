"""Review the saved trained-branch 0.2 SDR continuation and every track/stem regression."""
...
def main():
    ...
    from research.direct.prepare_latency58_branch_sdr_blend import RECIPE
    ...
    root = PHASE / "branch-sdr-blend-001"
    ...
    preparation_execution = PHASE / "branch-sdr-blend-preparation-stage-001/execution.json"
    ...
    require(parent["checkpoint"] == plan["parent_checkpoint"]
            and parent["aggregate"]["full_sdr_db"] == 4.391035784116766
            and plan["parent_kind"] == "saved_trained_branch_memory"
            and plan["parent_training_updates"] == 30250
    ...
    review = {"status": "selected_for_research" if selected else "not_selected",
              ...
              **completion_detail,
              ...
              "graph_plus_host_delay_samples": 256, "total_training_updates": 31250,
              "parent_training_updates": 30250, "objective_version": VERSION,
              ...
              "interpretation": "Single-seed continuation of the trained branch memories with the SDR auxiliary weight raised to 0.2, fresh Adam, a new schedule and sample range. Not an exact optimizer restart or a matched causal ablation of the coefficient alone. Track-bootstrap uncertainty excludes training-seed uncertainty and selection effects.",
