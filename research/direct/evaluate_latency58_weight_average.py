"""Score an audited equal-weight checkpoint average with the preserved streamer."""
...
from research.direct.latency58_weight_average import load_evaluation_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-weight-average-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "new_training_updates": 0, "averaged_component_steps": receipt["component_steps"], "provenance": model.provenance,
