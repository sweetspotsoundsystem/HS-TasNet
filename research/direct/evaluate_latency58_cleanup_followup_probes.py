"""Run preserved bass probes through an audited cleanup_followup generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-cleanup-followup-probe-plan-v1"
    ...
    report = {"schema": "latency58-cleanup-followup-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
