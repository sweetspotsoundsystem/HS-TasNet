"""Run preserved bass probes through an audited counterfactual generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-counterfactual-probe-plan-v1"
    ...
    report = {"schema": "latency58-counterfactual-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
