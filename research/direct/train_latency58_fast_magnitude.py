"""Magnitude continuation with eight-example microbatches and one-second scored suffixes."""
...
def main():
    ...
    from research.direct.latency58_wave_spectral import objective, VERSION, AUGMENTATION, augment
    ...
    if stage["resource_only"]:
        from research.direct.check_latency58_fast_context import check_gpu
