...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-primary-regression-audio-plan-v6"
    ...
    require(saved["schema"] == "latency58-primary-regression-audio-v5" and saved["status"] == "pass"
    ...
    write(out / "result.json", {"schema": "latency58-primary-regression-audio-v6", "status": "pass",
