...
def main():
    ...
    from research.direct.latency58_leader_cleanup_checkpoint import validate_recipe
    validate_recipe(plan)
    require(stage["schema"] == "latency58-leader-cleanup-stage-v1"
    ...
    from research.direct.latency58_leader_cleanup_checkpoint import (
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-leader-cleanup-resource-result-v1", "status": "pass",
