...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "hare-loss-ablation-training-v1", "Unknown training plan")
    from research.direct.hare_loss_ablation_checkpoint import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "hare-loss-ablation-audit-v1", "status": "pass", "step": step,
