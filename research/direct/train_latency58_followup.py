"""Matched GPU-only hop128 loss follow-up from an explicit inference parent.
...
def main():
    ...
    config = plan["config"]
    require(plan["objective"] in ("raw4_l1", "deployed4_l1")
    ...
    require(parent_step == 2000 and state_sha256(model.state_dict()) == plan["initial_model_state_sha256"]
            and model.provenance["training_updates"] == plan["parent_training_updates"]
            and model.provenance["pilot_updates"] == plan["parent_hop128_updates"],
