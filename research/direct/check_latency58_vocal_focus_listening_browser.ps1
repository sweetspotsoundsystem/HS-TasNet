param(
    ...
    [ValidateSet("original", "focused", "focused_mixer")][string]$LastArm = "original",
    [int]$DebugPort = 9234
)
...
'@
    ...
    $report = @{schema="latency58-vocal-focus-listening-browser-check-v1"; status="pass";
    ...
    $report = @{schema="latency58-vocal-focus-listening-browser-check-v1"; status="failed";
