"""Screen the untrained plateau carrier with the unchanged hop128 bass probes.
...
def main():
    ...
    require(plan["schema"] == "latency58-plateau-probe-plan-v1"
    ...
    report = {"schema": "latency58-plateau-probe-result-v1", "status": "pass", "checkpoint": None,
