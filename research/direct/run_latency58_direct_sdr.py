"""Prepare, monitor, audit and score one direct-SDR training pilot."""
...
def launch(plan_path, previous_execution_path, *, resource):
    ...
    spec = {"schema": "gpu-watchdog-launch-v1", "cwd": str(ROOT), "environment": plan["environment"],
            ...
            "argv": [PYTHON, "-u", "-m", "research.direct.train_latency58_direct_sdr", "--plan", str(plan_path),
...
def prepare(args):
    ...
    paths = [Path(__file__).resolve(), ROOT / "research/direct/latency58_direct_sdr.py",
             ROOT / "research/direct/latency58_direct_sdr_checkpoint.py", ROOT / "research/direct/train_latency58_direct_sdr.py",
             ROOT / "research/direct/evaluate_latency58_direct_sdr.py", ROOT / "research/direct/reserve_latency58_direct_sdr.py",
             Path(parent["path"]), reference_path, PHASE / "direct-sdr-storage-001/receipt.json",
    ...
    write(out / "preparation.json", {"status": "pass", "parent_model_state_sha256": plan["parent_model_state_sha256"],
          ...
          "rationale": "Direct deployed SDR supervision; equal stem weights; absence and small pre-residual L1 anchors; no teacher ceiling.",
...
def main():
    ...
    parser.add_argument("--name", default="direct-sdr-001")
    parser.add_argument("--steps", type=int, default=250)
    parser.add_argument("--lr", type=float, default=1e-5)
    parser.add_argument("--seed", type=int, default=20260925)
    parser.add_argument("--data-start", type=int, default=1_000_000)
    ...
    resource = launch(plan_path, PHASE / "latency58-reduced-teacher-001/production/execution.json", resource=True)
