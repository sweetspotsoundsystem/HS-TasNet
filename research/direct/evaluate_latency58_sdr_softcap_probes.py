"""Run preserved bass probes through an audited soft-capped SDR generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-softcap-probe-plan-v1"
    ...
    from research.direct.evaluate_latency58_sdr_softcap import load_evaluation_model
    ...
    report = {"schema": "latency58-sdr-softcap-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
