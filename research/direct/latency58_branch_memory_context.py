"""Detached warmup with final-frame decoding for the branch_memory prototype."""
import torch
...
def render_scored_context(model, mixture, *, warmup_samples, carry_state):
    ...
    require(type(model) is Latency58BranchMemoryModel, "Require the branch_memory model")
