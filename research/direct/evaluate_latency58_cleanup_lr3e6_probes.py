"""Run preserved bass probes through an audited cleanup_lr3e6 generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-cleanup-lr3e6-probe-plan-v1"
    ...
    report = {"schema": "latency58-cleanup-lr3e6-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
