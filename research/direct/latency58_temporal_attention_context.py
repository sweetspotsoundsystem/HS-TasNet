"""Detached warmup with final-frame decoding for the temporal_attention prototype."""
import torch
...
def render_scored_context(model, mixture, *, warmup_samples, carry_state):
    require(carry_state is True and type(warmup_samples) is int and warmup_samples > 0
            ...
            "Invalid temporal_attention training context")
    require(type(model) is Latency58TemporalAttentionModel, "Require the temporal_attention model")
