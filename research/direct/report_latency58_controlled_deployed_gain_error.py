...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-controlled-deployed-gain-error-plan-v1"
            and set(plan["references"]) == {"working", "focused_control", "ordinary_control", "drum500", "drum1000"}, "Different comparison scope")
    verify_inputs(plan)
    ...
    verify_inputs(plan)
    write(out / "result.json", {"schema": "latency58-controlled-deployed-gain-error-v1", "status": "pass",
