...
def main():
    ...
    root = PHASE / "branch-long-context-004"
    ...
    for path in (root / "resource-stage/execution.json", root / "production-stage/execution.json",
                 ...
                 PHASE / "branch-long-context-preparation-stage-004/execution.json",
                 PHASE / "branch-long-context-preparation-stage-004/root-execution.json"):
        execution = read(path)
