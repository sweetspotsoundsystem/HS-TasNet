"""Audit a selective-distillation model, Adam state, RNG and per-example loss journal."""
...
def main():
    ...
    from research.direct.latency58_counterfactual_checkpoint import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "latency58-counterfactual-audit-v1", "status": "pass", "step": step,
