"""Two-update rehearsal or 250-update matched quarter-controlled-view trial."""
...
def main():
    ...
    require(stage["schema"] == "latency58-quarter-controlled-stage-v1"
    ...
    from research.direct.latency58_quarter_controlled_checkpoint import (
    ...
    from research.direct.latency58_quarter_controlled_augmentation import augment_vocal_focus
    ...
    from research.direct.latency58_quarter_controlled_journal import loss_evidence
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-quarter-controlled-resource-result-v1", "status": "pass",
