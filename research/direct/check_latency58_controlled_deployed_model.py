...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-controlled-deployed-model-check-plan-v1", "Unknown model check")
    ...
    import torch
    from research.direct.latency58_counterfactual_checkpoint import load_parent
    ...
    verify_inputs(plan)
    write(out / "result.json", {"schema": "latency58-controlled-deployed-model-check-v1", "status": "pass",
