...
from research.direct.latency58_four_second_evaluation import evaluation_storage
...
def initialize_worker(plan):
    ...
    from research.direct.latency58_four_second_evaluation import load_model
