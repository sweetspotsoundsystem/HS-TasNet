...
def training_plan(plan):
    ...
    require(prepared["name"] == "branch-weighted-vocal-014" and prepared["config"]["steps"] == 1000,
...
def load_model(plan, spec):
    import torch
    from research.direct.latency58_lossless_recovery_files_v3 import load_inference, FINAL
