...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-log-relative-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "log_relative_candidate", "Unsupported parallel evaluation")
