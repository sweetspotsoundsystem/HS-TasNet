"""Read-only CPU audit of stronger soft-capped SDR weights, Adam, RNG and loss journal."""
...
def main():
    ...
    from research.direct.latency58_sdr_softcap_strong_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-sdr-softcap-strong-audit-v1", "status": "pass", "step": step,
              ...
              "scored_samples": plan["scored_samples"], "sdr_softcap_weight": plan["sdr_softcap_weight"],
              "sdr_softcap_version": plan["sdr_softcap_version"],
