"""Detached warmup with final-frame decoding for the fusion_refinement prototype."""
import torch
...
def render_scored_context(model, mixture, *, warmup_samples, carry_state):
    require(carry_state is True and type(warmup_samples) is int and warmup_samples > 0
            ...
            "Invalid fusion_refinement training context")
    require(type(model) is Latency58FusionRefinementModel, "Require the fusion_refinement model")
