"""Score an audited cleanup_rebound generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_cleanup_rebound_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-cleanup-rebound-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "cleanup_rebound_trial_updates": receipt["step"], "provenance": model.provenance,
