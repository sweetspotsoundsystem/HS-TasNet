"""Check real host continuity and both persistent workers after the step-141 timeout.
...
CONTROL = PHASE / "nvml-monitor-check-001"
TRANSPORT_CONTROL = PHASE / "nvml-transport-check-001"
OUT = PHASE / "branch-grouped-vocal-nvml-idle-001"
WATCHDOG = PHASE.parent / "latency11/smoke/gpu-crash-followup/watch_gpu_process_nvml.py"
WATCHDOG_SHA = "76f5da360bbfafb91c4705144265d92dd913a285ae0c0500833b38e54f74fc37"
...
def prepare():
    ...
    require(failed_execution["actual_exit_code"] == failed_root["actual_exit_code"] == 1
            ...
            and failed_root["actual_session_id"] == 51274 and failed_root["actual_tool_chunk_id"] == "3285b0"
            and failed["child_exit_code"] == 1 and failed["latest_completed_step_seen"] == 141
    ...
    spec = {"schema": "gpu-watchdog-launch-finalization-v1", "cwd": str(ROOT),
            ...
            "argv": [PYTHON, "-u", "-m", "research.direct.recover_latency58_nvml_idle",
