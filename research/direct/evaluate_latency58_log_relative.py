"""Score an audited weak relative-error generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_log_relative_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-log-relative-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "log_relative_trial_updates": receipt["step"], "provenance": model.provenance,
