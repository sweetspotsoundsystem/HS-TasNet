...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-weight-average-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "weight_average_candidate", "Unsupported parallel evaluation")
