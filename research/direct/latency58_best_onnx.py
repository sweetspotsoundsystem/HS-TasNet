"""Literal-hop export copies for the selected fusion or attention research model.
...
def interface(model):
    require(type(model) in (Latency58FusionRefinementModel, Latency58TemporalAttentionModel),
            "Require an authenticated fusion or attention model")
