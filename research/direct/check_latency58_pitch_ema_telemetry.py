"""Check event continuity after the stopped pitch/EMA run without a GPU workload."""
import argparse
import json
...
def main():
    ...
    require(failed["status"] == "stopped_by_watchdog" and failed["child_exit_code"] == -9
    ...
    monitor = load_source("pitch_ema_recovery_monitor", inputs["watchdog_source"])
