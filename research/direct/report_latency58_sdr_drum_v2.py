...
def main():
    ...
    require(training["schema"] == "latency58-sdr-drum-training-v2", "Unknown drum-weighted training plan")
    ...
    report = {
        "schema": "latency58-sdr-drum-quality-summary-v2", "prefix": args.prefix, "step": plans["full14"]["step"],
