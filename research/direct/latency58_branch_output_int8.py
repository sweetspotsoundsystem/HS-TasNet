...
def build(parent):
    ...
    require(hashlib.sha256(parent.SerializeToString()).hexdigest()
            == "878c74694fa4c558de1c5a75837893a0afeadcf57f6e3b860d5904cab04e9fc9",
...
def make_reference(native, ten_graph, ten_conversion, fourteen_graph, fourteen_conversion, candidate, conversion):
    ...
    from research.direct.latency58_branch_gru_int8 import make_reference as parent_reference
