"""Keep a pending temporal-attention save reserved during concurrent CPU qualification."""
...
def require_cpu_space(plan, extra_bytes):
    require(plan["schema"] == "latency58-temporal-attention-training-plan-v1" and extra_bytes >= 0,
            "Require an authenticated temporal-attention budget and a nonnegative CPU reservation")
    ...
    for _ in range(31):
        ...
        if final.exists():
            ...
            require(receipt["schema"] == "latency58-temporal-attention-generation-v1"
