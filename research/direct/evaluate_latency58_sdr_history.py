"""Score an audited history-trial generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_sdr_history_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-history-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "history_trial_updates": receipt["step"], "provenance": model.provenance,
