"""Read-only CPU audit of soft-capped SDR weights, Adam, RNG and loss journal."""
...
def main():
    ...
    from research.direct.latency58_sdr_softcap_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-sdr-softcap-audit-v1", "status": "pass", "step": step,
