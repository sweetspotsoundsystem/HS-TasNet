"""One matched two-update rehearsal or complete 250-update vocal-focus pilot."""
...
def main():
    ...
    from research.direct.latency58_vocal_focus_checkpoint import validate_recipe
    validate_recipe(plan)
    require(stage["schema"] == "latency58-vocal-focus-stage-v1"
    ...
    from research.direct.latency58_vocal_focus_checkpoint import (
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-vocal-focus-resource-result-v1", "status": "pass",
