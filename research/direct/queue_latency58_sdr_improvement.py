"""Score the running zero-loss trial for SDR improvement on the unchanged primary protocol."""
...
def main():
    ...
    for label, directory in (
        ...
        ("shared_parent", PHASE / "sdr-drum-accum-500-full14-001")):
    ...
    require(reference_states["shared_parent"] == training["parent"]["model_state_sha256"]
            and reference_states["current_best_c204"] == read(training["matched_positive_receipt"]["path"])["model_state_sha256"]
