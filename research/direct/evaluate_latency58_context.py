"""Score an audited context trial generation with the preserved CPU1 streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_context_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-context-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "context_trial_updates": receipt["step"], "provenance": model.provenance,
