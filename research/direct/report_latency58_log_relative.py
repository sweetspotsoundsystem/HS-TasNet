"""Compare a weak relative-error candidate with its parent and working baseline."""
...
def main():
    ...
    require(training["schema"] == "latency58-log-relative-training-v1", "Unknown relative-error training plan")
    ...
    report = {
        "schema": "latency58-log-relative-quality-summary-v1", "prefix": args.prefix, "step": plans["full14"]["step"],
        ...
        "log_relative_weight": training["log_relative_weight"], "log_relative_version": training["log_relative_version"],
