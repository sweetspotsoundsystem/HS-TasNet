"""Read-only CPU audit of weak log-relative weights, Adam, RNG and loss journal."""
...
def main():
    ...
    from research.direct.latency58_log_relative_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-log-relative-audit-v1", "status": "pass", "step": step,
              ...
              "scored_samples": plan["scored_samples"], "log_relative_weight": plan["log_relative_weight"],
              "log_relative_version": plan["log_relative_version"],
