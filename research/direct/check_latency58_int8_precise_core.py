"""Screen higher precision only on paths feeding integer quantizers at unchanged tolerances."""
...
def main():
    ...
    out = PHASE / "m4-int8-precise-core-001"
    require(not out.exists(), "Preserve earlier screens")
    out.mkdir()
    paths = [source_path, Path(__file__).resolve(), ROOT / "research/direct/latency58_int8_precise_float.py", ROOT / "research/direct/latency58_int8_precise_core.py",
    ...
    write(out / "plan.json", {"source_bindings": bindings, "parent_graph": binding, "graph_sha256": candidate_sha,
          ...
          "arithmetic": "FP64 only on floating quantizer ancestors; original U8U8 blocks and FP32 decoding/public state",
