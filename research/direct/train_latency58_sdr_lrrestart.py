"""One monitored resource check or bounded higher-LR context training stage."""
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-lrrestart-training-v1" and stage["schema"] == "latency58-sdr-lrrestart-stage-v1"
            ...
            and config["lr"] == 1e-4 and config["min_lr"] == 1e-5 and config["warmup"] == 25,
    ...
    from research.direct.latency58_sdr_lrrestart_checkpoint import (
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-sdr-lrrestart-resource-result-v1", "status": "pass",
