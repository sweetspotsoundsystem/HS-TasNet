...
from research.direct.latency58_attention_qkv_fusion import build as fuse, PARENT_SHA
...
def build(parent):
    ...
    fused, fusion_proof = fuse(parent)
    require(hashlib.sha256(fused.SerializeToString()).hexdigest() == FUSED_SHA,
            "Qualified floating QKV transformation changed")
