"""Run preserved bass probes through an audited stronger soft-capped SDR generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-softcap-strong-probe-plan-v1"
    ...
    from research.direct.evaluate_latency58_sdr_softcap_strong import load_evaluation_model
    ...
    report = {"schema": "latency58-sdr-softcap-strong-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
