"""Compare a higher-LR context candidate with its parent and working baseline."""
...
def main():
    ...
    require(training["schema"] == "latency58-sdr-lrrestart-training-v1", "Unknown higher-LR training plan")
    ...
    for mode in ("full14", "actions60", "probes"):
        ...
        require(parent_state == training["parent"]["model_state_sha256"], "Different parent in higher-LR comparison")
    ...
    report = {
        "schema": "latency58-sdr-lrrestart-quality-summary-v1", "prefix": args.prefix, "step": plans["full14"]["step"],
        ...
        "limitations": ["Primary development-panel results; confirmation intervals remain outside selection.",
                        "No matched low-learning-rate control; changes cannot be attributed solely to the learning rate.",
