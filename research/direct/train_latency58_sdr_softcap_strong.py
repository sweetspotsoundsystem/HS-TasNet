"""One monitored resource check or bounded stronger soft-capped SDR training stage."""
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-softcap-strong-training-v1" and stage["schema"] == "latency58-sdr-softcap-strong-stage-v1"
            ...
            and plan["sdr_softcap_weight"] == 0.03,
    ...
    from research.direct.latency58_sdr_softcap_strong_checkpoint import (
    ...
    require(plan["sdr_softcap_weight"] == 10 * AUXILIARY_WEIGHT and plan["sdr_softcap_version"] == VERSION
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-sdr-softcap-strong-resource-result-v1", "status": "pass",
