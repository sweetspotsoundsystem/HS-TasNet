"""Measure long precise-integer quadrature trajectories at unchanged qualification tolerances."""
import hashlib
import json
import os
...
def main():
    ...
    screen_path = PHASE / "m4-quadrature-int8-screen-001/result.json"
    screen = read(screen_path)
    screen_execution_path = PHASE / "m4-quadrature-int8-screen-stage-001/execution.json"
    ...
    out = PHASE / "m4-quadrature-int8-long-001"
