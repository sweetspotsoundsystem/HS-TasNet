"""Run preserved bass probes through an audited accumulated-gradient context generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-history-probe-plan-v1"
    ...
    report = {"schema": "latency58-sdr-history-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
