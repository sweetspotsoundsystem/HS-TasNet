"""Original full14 quality plus fixed vocal views for the four-GRU experiment."""
...
def score(index):
    ...
    stream["precision"] = "Fourteen U8S8 projections, FP64 surrounding recurrence, FP32 decoding and eight public states"
...
def main():
    ...
    screen_root, long_root = PHASE / "branch-gru-int8-screen-002", PHASE / "branch-gru-int8-long-001"
    ...
    out = PHASE / "branch-gru-int8-quality-001"
    ...
    plan = {**baseline, "schema": "latency58-branch-gru-int8-quality-plan-v1",
        ...
        "diagnostic_artifact_allowance_bytes": 30_000_000,
        ...
        "purpose": "Measure quality and absence behavior after quantizing the four profiled branch GRU products"}
    ...
    candidate = {"model": {"label": "Saved EMA with fourteen signed integer projections",
