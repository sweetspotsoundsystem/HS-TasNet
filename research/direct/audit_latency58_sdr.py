"""Read-only CPU audit of an SDR trial's model, Adam state, RNG and journal."""
...
def main():
    ...
    from research.direct.latency58_sdr_checkpoint import load_model, read_generation
    ...
    for row in rows:
        require(row["teacher_kind"] == plan["teacher_kind"] and row["teacher_weight"] == plan["teacher_weight"]
                ...
                "Malformed or inconsistent objective journal")
    ...
    result = {"schema": "latency58-sdr-audit-v1", "status": "pass", "step": step,
              ...
              "source_bindings_unchanged": True, "cumulative_training_updates": 5000 + step,
