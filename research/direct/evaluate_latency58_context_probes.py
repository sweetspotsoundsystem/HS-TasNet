"""Run preserved bass probes through an audited context trial generation on CPU1.
...
def main():
    ...
    require(plan["schema"] == "latency58-context-probe-plan-v1"
    ...
    report = {"schema": "latency58-context-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
