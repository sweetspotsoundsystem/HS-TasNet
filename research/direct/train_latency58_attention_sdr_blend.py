"""Train the saved attention model with reconstruction plus a fixed direct-SDR auxiliary."""
...
def main():
    ...
    verify_inputs(stage)
    config = plan["config"]
    require(plan["schema"] == "latency58-temporal-attention-training-plan-v1" and stage["plan_sha256"] == args.plan_sha256
    ...
    from research.direct.latency58_attention_sdr_blend import objective, VERSION
    ...
    from research.direct.latency58_temporal_attention_checkpoint import audit_live, save_generation
    ...
    require(VERSION == plan["objective_version"] and plan["direct_sdr_weight"] == .1
