...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-cleanup-followup-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "cleanup_followup_candidate", "Unsupported parallel evaluation")
