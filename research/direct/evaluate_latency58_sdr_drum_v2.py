"""Score an audited drum-weighted context generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_sdr_drum_v2_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-drum-music-plan-v2"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "drum_emphasis_trial_updates": receipt["step"], "provenance": model.provenance,
