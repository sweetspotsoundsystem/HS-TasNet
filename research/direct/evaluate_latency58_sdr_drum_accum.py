"""Score an audited accumulated drum generation with the preserved streamer."""
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-drum-accum-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "drum_accum_trial_updates": receipt["step"], "provenance": model.provenance,
