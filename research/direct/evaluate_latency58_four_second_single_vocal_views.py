"""Score unchanged source views for an explicit role in a packed checkpoint."""
...
from research.direct.latency58_four_second_single_evaluation import evaluation_storage
...
def initialize_worker(plan):
    ...
    from research.direct.latency58_four_second_single_evaluation import load_model
    model, _ = load_model(plan, spec)
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-packed-branch-vocal-views-evaluation-plan-v1" and plan["workers"] == 2
    ...
    require(qualification["checkpoint"] == plan["model"]["checkpoint"]
            ...
            and qualification["checkpoint_role"] == plan["model"]["checkpoint_role"]
            and qualification["packed_training_plan"] == plan["packed_training_plan"],
            "Source views were not qualified on this exact checkpoint")
    require(plan["diagnostic_artifact_allowance_bytes"] == 10_000_000, "Diagnostic reservation changed")
