...
def main():
    ...
    from research.direct.latency58_sdr_drum_v2_checkpoint import read_generation, require_space
    ...
    require(functional["schema"] == "latency58-drum-emphasis-functional-result-v2"
    ...
    if plan["resource_only"]:
        ...
        require(resource["schema"] == "latency58-sdr-drum-resource-result-v2" and resource["status"] == "pass"
    ...
    if start:
        ...
        require(decision["schema"] == "latency58-sdr-drum-continuation-v2"
    ...
    stage = {"schema": "latency58-sdr-drum-stage-v2", "plan_sha256": args.plan_sha256,
    ...
    spec = {"schema": "gpu-watchdog-launch-v1", "cwd": str(ROOT), "environment": plan["environment"],
            ...
            "argv": [PYTHON, "-u", "-m", "research.direct.train_latency58_sdr_drum_v2", "--plan", str(args.plan.resolve()),
    ...
    if plan["resource_only"]:
        ...
        write(out / "resource-qualification.json", {
            "schema": "latency58-sdr-drum-resource-qualification-v2", "status": "pass",
    ...
    argv = [PYTHON, "-u", "-m", "research.direct.audit_latency58_sdr_drum_v2", "--plan", str(args.plan.resolve()),
    ...
    if previous_generation is not None:
        ...
        retirement = {"schema": "latency58-sdr-drum-replaced-optimizer-v2", "path": str(old_optimizer),
