"""Train causal trailing4096 magnitude features and all inherited layers."""
...
def main():
    ...
    model.provenance = {**model.provenance, "long_magnitude_current_stage_corpus": "301 recorded MUSDB18-HQ and MoisesDB training tracks",
    ...
    if stage["resource_only"]:
        from research.direct.check_latency58_long_magnitude_gpu import check_gpu
