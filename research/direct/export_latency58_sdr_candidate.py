"""CPU ONNX export for an audited SDR or context endpoint and its quality evidence.
...
def metadata(plan, model, step, fingerprint, shapes):
    ...
    loader = "latency58_context_checkpoint.py" if plan["model_kind"] == "context_candidate" else "latency58_sdr_checkpoint.py"
...
def main():
    ...
    require(plan["model_kind"] in ("sdr_candidate", "context_candidate")
            and plan["purpose"] in ("development_parity", "selected_candidate_parity"), "Unknown candidate or export purpose")
    loader_name = "latency58_context_checkpoint.py" if plan["model_kind"] == "context_candidate" else "latency58_sdr_checkpoint.py"
    for relative in ("research/direct/export_latency58_sdr_candidate.py", "research/direct/export_latency58_teacher.py",
                     "research/direct/report_latency58_sdr.py", "research/direct/evaluate_latency58_sdr.py",
                     "research/direct/evaluate_latency58_context.py",
