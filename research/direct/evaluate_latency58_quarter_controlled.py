"""Score an audited quarter_controlled generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_quarter_controlled_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-quarter-controlled-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "quarter_controlled_trial_updates": receipt["step"], "provenance": model.provenance,
