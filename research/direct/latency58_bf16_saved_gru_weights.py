...
def grouped_update(model, *args, **kwargs):
    from research.direct.latency58_weighted_vocal_canonical import grouped_update as original
    # Every completed update creates fresh value copies. The optimizer and EMA
    # retain the original parameters, operation order, gradients and precision.
    with share_saved_gru_weights(model):
