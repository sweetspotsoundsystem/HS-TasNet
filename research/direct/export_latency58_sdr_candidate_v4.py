...
def metadata(plan, model, step, fingerprint, shapes):
    ...
    loader = "latency58_" + CANDIDATE_FAMILIES[plan["model_kind"]] + "_checkpoint.py"
...
def main():
    ...
    loader_name = "latency58_" + family + "_checkpoint.py"
    evaluator_name = "evaluate_latency58_" + family
    for relative in ("research/direct/export_latency58_sdr_candidate_v4.py", "research/direct/export_latency58_teacher.py",
