"""Compare a lower-rate successor with the selected parent and retained references."""
...
REFERENCES = {"working": "teacher-half250", "parent": "cleanup-successor-250",
              "selected_release": "leader-cleanup-250"}


def reference_views(label):
    return PHASE / {"working": "vocal-views-working-001", "parent": "cleanup-successor-250-views-001",
                    "selected_release": "leader-cleanup-250-views-001"}[label]
...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-cleanup-followup-summary-plan-v1", "Unexpected summary plan")
    ...
    write(out / "result.json", {
        "schema": "latency58-cleanup-followup-quality-summary-v1", "status": "pass", "plan_sha256": args.plan_sha256,
        ...
        "all_metrics_compared": True, "comparison_variable": "fresh_adam_followup_with_new_batches",
        "matched_training_effect_claimed": False, "quality_selected": False, "human_listening_completed": False,
