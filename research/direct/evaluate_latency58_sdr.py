"""Score an audited SDR recovery generation with the preserved CPU1 streamer."""
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "sdr_trial_updates": receipt["step"], "provenance": model.provenance,
