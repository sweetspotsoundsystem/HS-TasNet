...
def metadata(plan, model, step, fingerprint, shapes):
    ...
    loader = {"sdr_candidate": "latency58_sdr_checkpoint.py",
              "context_candidate": "latency58_context_checkpoint.py",
              "log_relative_candidate": "latency58_log_relative_checkpoint.py"}[plan["model_kind"]]
...
def main():
    ...
    require(plan["model_kind"] in ("sdr_candidate", "context_candidate", "log_relative_candidate")
            and plan["purpose"] in ("development_parity", "selected_candidate_parity"), "Unknown candidate or export purpose")
    loader_name = {"sdr_candidate": "latency58_sdr_checkpoint.py",
                   "context_candidate": "latency58_context_checkpoint.py",
                   "log_relative_candidate": "latency58_log_relative_checkpoint.py"}[plan["model_kind"]]
    for relative in ("research/direct/export_latency58_sdr_candidate_v2.py", "research/direct/export_latency58_teacher.py",
                     "research/direct/report_latency58_sdr.py", "research/direct/evaluate_latency58_sdr.py",
                     "research/direct/evaluate_latency58_context.py", "research/direct/evaluate_latency58_log_relative.py",
    ...
    if plan["model_kind"] == "log_relative_candidate":
        from research.direct.evaluate_latency58_log_relative import load_evaluation_model
    elif plan["model_kind"] == "context_candidate":
