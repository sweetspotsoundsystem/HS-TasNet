...
def main():
    ...
    from research.direct.latency58_sdr_accum_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-sdr-accum-audit-v1", "status": "pass", "step": step,
