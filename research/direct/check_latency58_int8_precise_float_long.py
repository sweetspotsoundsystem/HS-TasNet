"""Measure long precise-integer trajectories at unchanged qualification tolerances."""
import hashlib
import json
import os
...
def main():
    ...
    from research.direct.latency58_int8_precise_float import make_reference, rewrite
    ...
    screen_path = PHASE / "m4-int8-precise-float-002/result.json"
    ...
    out = PHASE / "m4-int8-precise-float-long-001"
    require(not out.exists(), "Preserve long diagnostics")
    out.mkdir()
    paths = [source_path, Path(__file__).resolve(), ROOT / "research/direct/latency58_int8_reference.py", ROOT / "research/direct/latency58_int8_precise_float.py",
