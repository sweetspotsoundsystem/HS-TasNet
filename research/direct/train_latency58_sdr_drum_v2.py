...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-drum-training-v2" and stage["schema"] == "latency58-sdr-drum-stage-v2"
    ...
    from research.direct.latency58_sdr_drum_v2_checkpoint import (
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-sdr-drum-resource-result-v2", "status": "pass",
