"""Compare a candidate trained with accumulated gradients against its parent."""
...
def main():
    ...
    require(training["schema"] == "latency58-sdr-accum-training-v1", "Unknown accumulated-gradient training plan")
    ...
    report = {
        "schema": "latency58-sdr-accum-quality-summary-v1", "prefix": args.prefix, "step": plans["full14"]["step"],
        ...
        "limitations": ["Primary development-panel results; confirmation intervals remain outside selection.",
                        "No matched B4-update control; changed data exposure and update averaging prevent a causal batch-size claim.",
