...
def main():
    ...
    from research.direct.latency58_leader_cleanup_checkpoint_v2 import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "latency58-leader-cleanup-audit-v1", "status": "pass", "step": step,
