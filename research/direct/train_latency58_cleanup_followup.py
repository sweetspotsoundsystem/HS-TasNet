...
def main():
    ...
    from research.direct.latency58_cleanup_followup_checkpoint import validate_recipe
    validate_recipe(plan)
    require(stage["schema"] == "latency58-cleanup-followup-stage-v1"
    ...
    from research.direct.latency58_cleanup_followup_checkpoint import (
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-cleanup-followup-resource-result-v1", "status": "pass",
