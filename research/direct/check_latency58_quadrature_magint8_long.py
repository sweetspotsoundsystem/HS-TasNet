"""Measure long ten-projection integer quadrature trajectories at unchanged qualification tolerances."""
import hashlib
import json
import os
...
def main():
    ...
    screen_execution_path = PHASE / "m4-quadrature-magint8-screen-stage-001/execution.json"
    ...
    out = PHASE / "m4-quadrature-magint8-long-001"
    ...
    paths.extend(ROOT / "research/direct" / name for name in ("latency58_quadrature_magint8.py", "latency58_int8_precise_ten.py"))
