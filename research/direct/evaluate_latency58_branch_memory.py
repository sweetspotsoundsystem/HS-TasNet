"""Unchanged full14 music scoring for saved branch_memory inference checkpoints."""
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-branch-memory-full14-plan-v1" and plan["track_indices"] == list(range(14))
    ...
    write(out / "result.json", {"schema": "latency58-branch-memory-full14-result-v1", "status": "pass",
