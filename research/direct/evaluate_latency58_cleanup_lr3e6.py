"""Score an audited cleanup_lr3e6 generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_cleanup_lr3e6_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-cleanup-lr3e6-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "cleanup_lr3e6_trial_updates": receipt["step"], "provenance": model.provenance,
