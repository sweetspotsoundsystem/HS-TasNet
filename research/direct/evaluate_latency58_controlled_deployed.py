"""Score an audited controlled_deployed generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_controlled_deployed_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-controlled-deployed-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "controlled_deployed_trial_updates": receipt["step"], "provenance": model.provenance,
