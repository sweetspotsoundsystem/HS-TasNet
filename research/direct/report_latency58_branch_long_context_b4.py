...
def main():
    ...
    root = PHASE / "branch-long-context-003"
    ...
    for path in (root / "resource-stage/execution.json", root / "production-stage/execution.json",
                 ...
                 PHASE / "branch-long-context-preparation-stage-003/execution.json",
                 PHASE / "branch-long-context-preparation-stage-003/root-execution.json"):
        execution = read(path)
