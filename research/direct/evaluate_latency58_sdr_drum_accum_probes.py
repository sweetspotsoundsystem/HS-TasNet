...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-drum-accum-probe-plan-v1"
    ...
    report = {"schema": "latency58-sdr-drum-accum-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
