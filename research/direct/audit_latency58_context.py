...
def main():
    ...
    from research.direct.latency58_context_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-context-audit-v1", "status": "pass", "step": step,
