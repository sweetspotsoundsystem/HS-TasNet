"""Score the same fixed vocal counterfactuals for a completed vocal-focus pilot."""
...
def initialize_worker(plan):
    ...
    spec = plan["model"]
    require(spec["kind"] == "vocal_focus", "Require the new vocal-focus checkpoint family")
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-vocal-focus-views-evaluation-plan-v1" and plan["workers"] == 2
