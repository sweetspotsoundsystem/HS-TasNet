"""Run preserved bass probes through an audited equal-weight checkpoint average.
...
def main():
    ...
    require(plan["schema"] == "latency58-weight-average-probe-plan-v1"
    ...
    report = {"schema": "latency58-weight-average-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
