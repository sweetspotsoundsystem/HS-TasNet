...
def initialize_worker(plan):
    ...
    from research.direct.evaluate_latency58_reduced_teacher import load_evaluation_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-reduced-teacher-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "latency58_reduced_teacher_candidate", "Unsupported parallel evaluation")
