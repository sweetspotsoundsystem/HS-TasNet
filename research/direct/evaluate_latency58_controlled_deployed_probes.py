"""Run preserved bass probes through an audited controlled_deployed generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-controlled-deployed-probe-plan-v1"
    ...
    report = {"schema": "latency58-controlled-deployed-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
