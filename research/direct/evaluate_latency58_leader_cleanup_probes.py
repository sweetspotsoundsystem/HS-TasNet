"""Run preserved bass probes through an audited leader_cleanup generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-leader-cleanup-probe-plan-v1"
    ...
    report = {"schema": "latency58-leader-cleanup-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
