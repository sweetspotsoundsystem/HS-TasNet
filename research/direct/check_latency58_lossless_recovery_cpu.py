...
from research.direct.latency58_lossless_recovery_codec import (
    ...
    MAX_FILE_BYTES, MAX_METADATA_BYTES, TENSOR_CODEC)
from research.direct.latency58_lossless_recovery_files import (
...
def primitive_checks():
    ...
    reject(rejected, "metadata_numeric_nodes", lambda: metadata_inventory([1] * 200_001))
    nested = 1
    for _ in range(34):
        nested = [nested]
...
def main():
    ...
    out = PHASE / "lossless-recovery-cpu-001"
    ...
    paths.extend(ROOT / "research/direct" / name for name in (
        "latency58_lossless_recovery_codec.py", "latency58_lossless_recovery_files.py",
