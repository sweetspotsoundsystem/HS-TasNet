"""Unchanged full14 music scoring for a recurrent-feature-conditioned output correction."""
...
def initialize(plan):
    ...
    import torch
    from research.direct.latency58_dynamic_mixer import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-direct-sdr-full14-plan-v1" and plan["track_indices"] == list(range(14))
    ...
    write(out / "result.json", {"schema": "latency58-direct-sdr-full14-result-v1", "status": "pass",
