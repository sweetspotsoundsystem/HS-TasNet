...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "hare-loss-ablation-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "hare_loss_ablation_candidate", "Unsupported parallel evaluation")
