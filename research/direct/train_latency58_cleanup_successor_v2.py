...
def main():
    ...
    from research.direct.latency58_cleanup_successor_checkpoint_v2 import validate_recipe
    ...
    from research.direct.latency58_cleanup_successor_checkpoint_v2 import (
