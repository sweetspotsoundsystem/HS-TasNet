...
def main():
    ...
    from research.direct.latency58_sdr_drum_v3_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-sdr-drum-audit-v3", "status": "pass", "step": step,
