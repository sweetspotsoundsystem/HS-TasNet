"""One matched rehearsal or 250-update controlled deployed-truth pilot."""
...
def main():
    ...
    from research.direct.latency58_controlled_deployed_checkpoint import validate_recipe
    validate_recipe(plan)
    require(stage["schema"] == "latency58-controlled-deployed-stage-v1"
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            if plan["additional_loss_weight"] == 0:
                old_resource = read(plan["reference_resource"]["path"])
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "latency58-controlled-deployed-resource-result-v1", "status": "pass",
                ...
                "existing_control_prefix_exact": plan["additional_loss_weight"] == 0,
