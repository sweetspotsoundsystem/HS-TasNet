"""Score an audited leader_cleanup generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_leader_cleanup_checkpoint_v2 import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-leader-cleanup-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "leader_cleanup_trial_updates": receipt["step"], "provenance": model.provenance,
