...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-drum-probe-plan-v1"
    ...
    from research.direct.evaluate_latency58_sdr_drum import load_evaluation_model
    ...
    report = {"schema": "latency58-sdr-drum-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
