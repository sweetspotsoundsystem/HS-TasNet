"""Score an audited counterfactual generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_counterfactual_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-counterfactual-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "counterfactual_trial_updates": receipt["step"], "provenance": model.provenance,
