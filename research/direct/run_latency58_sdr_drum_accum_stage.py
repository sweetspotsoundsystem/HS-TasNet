"""Run a monitored rehearsal or independently audited accumulated drum stage."""
...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-sdr-drum-accum-training-v1", "Unknown training plan")
    ...
    require(functional["schema"] == "latency58-drum-accum-functional-result-v1"
    ...
    if plan["resource_only"]:
        ...
        require(resource["schema"] == "latency58-sdr-drum-accum-resource-result-v1" and resource["status"] == "pass"
    ...
    if start:
        ...
        require(decision["schema"] == "latency58-sdr-drum-accum-continuation-v1"
    ...
    stage = {"schema": "latency58-sdr-drum-accum-stage-v1", "plan_sha256": args.plan_sha256,
    ...
    spec = {"schema": "gpu-watchdog-launch-v1", "cwd": str(ROOT), "environment": plan["environment"],
            ...
            "argv": [PYTHON, "-u", "-m", "research.direct.train_latency58_sdr_drum_accum", "--plan", str(args.plan.resolve()),
    ...
    if plan["resource_only"]:
        ...
        write(out / "resource-qualification.json", {
            "schema": "latency58-sdr-drum-accum-resource-qualification-v1", "status": "pass",
    ...
    argv = [PYTHON, "-u", "-m", "research.direct.audit_latency58_sdr_drum_accum", "--plan", str(args.plan.resolve()),
    ...
    if previous_generation is not None:
        ...
        retirement = {"schema": "latency58-sdr-drum-accum-replaced-optimizer-v1", "path": str(old_optimizer),
