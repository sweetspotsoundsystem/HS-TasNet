"""Score one matched-loss endpoint using the executed Hann +2000 protocol.
...
def main():
    ...
    require(training["schema"] == "latency58-followup-training-plan-v1", "Use a matched-loss follow-up plan")
    ...
    for mode in ("actions60", "full14", "probes"):
        ...
        plan.update(checkpoint=checkpoint, output_directory=str(out), source_bindings={**unchanged, **bindings},
