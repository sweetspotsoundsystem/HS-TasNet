...
def main():
    ...
    from research.direct.latency58_attention_onnx_arithmetic import transform
    ...
    paths.extend((ROOT / "research/direct/latency58_attention_onnx_arithmetic.py",
    ...
    out = PHASE / "attention-onnx-drift-diagnostic-004"
    ...
    write(out / "plan.json", {"source_bindings": bindings, "checkpoint": checkpoint,
          ...
          "variants": ["fused_gru", "split_gru_bias", "precise_gru_gemm"],
    ...
    for label in ("fused_gru", "split_gru_bias", "precise_gru_gemm"):
