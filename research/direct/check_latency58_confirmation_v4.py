...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-confirmation-v4-preflight-plan-v1", "Different confirmation preflight")
    ...
    previous = definitions(ROOT / "research/direct/evaluate_latency58_sdr_confirmation_v3.py")
    current = definitions(ROOT / "research/direct/evaluate_latency58_sdr_confirmation_v4.py")
    ...
    from research.direct.evaluate_latency58_sdr_confirmation_v4 import validate_selection
    try:
    ...
    verify_inputs(plan)
    write(out / "result.json", {"schema": "latency58-confirmation-v4-preflight-v1", "status": "pass",
