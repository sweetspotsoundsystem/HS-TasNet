"""Measure FP32 warmup mismatch on fixed training tracks, without fitting weights."""
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-context-horizon-diagnostic-v1"
    ...
    write(out / "result.json", {"schema": "latency58-context-horizon-diagnostic-result-v1", "status": "pass",
          ...
          "limitations": ["Three fixed training tracks; no primary or reserved confirmation quality scoring.",
