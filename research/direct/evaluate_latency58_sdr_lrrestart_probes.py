"""Run preserved bass probes through an audited higher-LR context generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-lrrestart-probe-plan-v1"
    ...
    from research.direct.evaluate_latency58_sdr_lrrestart import load_evaluation_model
    ...
    report = {"schema": "latency58-sdr-lrrestart-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
