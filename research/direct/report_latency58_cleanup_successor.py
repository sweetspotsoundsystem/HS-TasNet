...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-cleanup-successor-summary-plan-v1", "Unexpected summary plan")
    ...
    write(out / "result.json", {
        "schema": "latency58-cleanup-successor-quality-summary-v1", "status": "pass", "plan_sha256": args.plan_sha256,
        ...
        "all_metrics_compared": True, "comparison_variable": "fresh_adam_lower_lr_successor",
