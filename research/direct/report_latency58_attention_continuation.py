"""Review the completed saved-attention continuation against its parent and rollback baselines."""
...
def main():
    ...
    root = PHASE / "attention-continuation-001"
    ...
    require(parent["checkpoint"] == plan["parent_checkpoint"]
            and parent["aggregate"]["full_sdr_db"] == 4.288099064999147
            and plan["parent_kind"] == "saved_temporal_attention"
            and plan["parent_training_updates"] == 21250
    ...
    review = {"status": "selected_for_research" if selected else "not_selected",
              ...
              "graph_plus_host_delay_samples": 256, "total_training_updates": 25250,
              "continuation_uses_trained_nonzero_attention_head": True,
              "optimizer_initialization": "fresh_adam",
              "interpretation": "Single-seed continuation with fresh Adam, a new schedule and a new sample range; not an exact optimizer restart or a matched causal ablation. Track-bootstrap uncertainty excludes training-seed uncertainty and selection effects.",
