...
def main():
    ...
    plan = read(args.plan)
    verify_inputs(plan)
    require(plan["schema"] == "latency58-cleanup-lr3e6-training-v1", "Unknown training plan")
    from research.direct.latency58_cleanup_lr3e6_checkpoint import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "latency58-cleanup-lr3e6-audit-v1", "status": "pass", "step": step,
