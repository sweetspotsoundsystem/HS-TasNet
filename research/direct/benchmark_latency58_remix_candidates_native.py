"""Compare C204 FP32 and the checked C204 and improved-remix precise U8U8 candidates with the plugin's native ORT 1.26 CPU SDK.
...
REMIX_INT8_SHA = "4c17744b2460d6948336b99ae4f53349d4977cd8ed002b687acfe8d943b092d8"
...
def main():
    ...
    parser.add_argument("--remix-int8", type=Path, required=True, help="Saved precise remix-magnitude integer graph")
    ...
    result = {"status": "pass", "plan_sha256": sha(args.output / "plan.json"), "cycles": rows,
              ...
              "remix_over_c204_integer_ratio": medians["int8_remix"] / medians["int8_c204"],
    ...
    print(json.dumps({key: result[key] for key in ("status", "median_of_cycle_p50_ms", "ratios_to_fp32_c204", "remix_over_c204_integer_ratio")}), flush=True)
