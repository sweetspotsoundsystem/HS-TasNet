"""Run preserved bass probes through an audited vocal-focus generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-vocal-focus-probe-plan-v1"
    ...
    report = {"schema": "latency58-vocal-focus-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
