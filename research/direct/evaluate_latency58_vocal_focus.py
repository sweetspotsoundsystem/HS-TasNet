"""Score an audited vocal-focus generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_vocal_focus_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-vocal-focus-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "vocal_focus_trial_updates": receipt["step"], "provenance": model.provenance,
