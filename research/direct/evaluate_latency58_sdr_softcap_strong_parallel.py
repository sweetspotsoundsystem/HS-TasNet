...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-softcap-strong-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "sdr_softcap_strong_candidate", "Unsupported parallel evaluation")
