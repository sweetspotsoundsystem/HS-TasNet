"""Audit an accumulated drum trial's model, Adam state, RNG and objective journal."""
...
def main():
    ...
    from research.direct.latency58_sdr_history_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-sdr-history-audit-v1", "status": "pass", "step": step,
              ...
              "teacher_history_samples": plan["teacher_history_samples"], "history_version": plan["history_version"],
