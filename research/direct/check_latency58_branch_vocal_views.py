"""Qualify continuous source views on the exact saved eight-state branch checkpoint."""
...
def main():
    ...
    model, _ = load_model(plan["checkpoint"])
    ...
    verify_inputs(plan)
    result = {"schema": "latency58-branch-vocal-views-functional-result-v1", "status": "pass", "version": VERSION,
              ...
              "counted_bytes_after": require_space(plan, 440_000_000), "cuda_initialized": False,
