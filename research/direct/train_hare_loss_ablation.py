"""A matched zero-weight deployed-output loss ablation from the SDR leader."""
...
def main():
    ...
    from research.direct.hare_loss_ablation_checkpoint import validate_recipe
    validate_recipe(plan)
    require(stage["schema"] == "hare-loss-ablation-stage-v1"
    ...
    from research.direct.hare_loss_ablation_checkpoint import (
    ...
    from research.direct.hare_loss_ablation_checkpoint import compare_inputs
    ...
    try:
        ...
        if plan["resource_only"]:
            ...
            helpers.atomic_json(run / "resource.json", {
                "schema": "hare-loss-ablation-resource-result-v1", "status": "pass",
