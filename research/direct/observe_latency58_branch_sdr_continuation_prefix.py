...
def main():
    ...
    paths = [plan_path, Path(__file__).resolve(), ROOT / "research/direct/report_latency58_branch_sdr_continuation.py",
             root / "resource-stage/root-execution.json", root / "resource-stage/execution.json",
             root / "resource-run/result.json", PHASE / "branch-sdr-continuation-preparation-stage-001/execution.json",
             PHASE / "branch-sdr-continuation-preparation-stage-001/root-execution.json"]
