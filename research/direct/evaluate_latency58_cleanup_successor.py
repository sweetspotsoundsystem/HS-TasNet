"""Score an audited cleanup_successor generation with the preserved streamer."""
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-cleanup-successor-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "cleanup_successor_trial_updates": receipt["step"], "provenance": model.provenance,
