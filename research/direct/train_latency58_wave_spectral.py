"""Full-model waveform/spectral reconstruction on augmented recorded training music."""
...
def main():
    ...
    from research.direct.latency58_direct_sdr_checkpoint import load_model, audit_live, save_generation
