...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-cleanup-successor-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "cleanup_successor_candidate", "Unsupported parallel evaluation")
