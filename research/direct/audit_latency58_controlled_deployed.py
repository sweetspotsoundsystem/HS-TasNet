...
def main():
    ...
    from research.direct.latency58_controlled_deployed_checkpoint import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "latency58-controlled-deployed-audit-v1", "status": "pass", "step": step,
