...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-history-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "history_candidate", "Unsupported parallel evaluation")
