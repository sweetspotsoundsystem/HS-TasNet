"""Run preserved bass probes through an audited SDR recovery generation on CPU1.
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-probe-plan-v1"
    ...
    report = {"schema": "latency58-sdr-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
