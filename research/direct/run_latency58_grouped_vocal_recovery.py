"""Run canonical accumulation with qualified rolling-file recovery."""
...
def launch(plan_path, previous_execution_path, *, resource):
    ...
    spec = {"schema": "gpu-watchdog-launch-finalization-v1", "expected_final_step": stop,
            ...
            "argv": [PYTHON, "-u", "-m", "research.direct.train_latency58_grouped_vocal_recovery", "--plan", str(plan_path),
