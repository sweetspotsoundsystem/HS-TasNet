"""Score an audited stronger soft-capped SDR generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_sdr_softcap_strong_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-softcap-strong-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "sdr_softcap_strong_trial_updates": receipt["step"], "provenance": model.provenance,
