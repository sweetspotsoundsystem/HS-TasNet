...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-leader-cleanup-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "leader_cleanup_candidate", "Unsupported parallel evaluation")
