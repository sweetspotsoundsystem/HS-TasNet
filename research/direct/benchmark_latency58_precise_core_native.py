"""Compare saved C204 FP32 and precise-core U8U8 graphs with the plugin's native ORT 1.26 CPU SDK.
...
CANDIDATE_SHA = "a550c904ef501fe98f3afa010eca5a53abd5bf66d63906e018511a01c5076d61"
...
def main():
    ...
    parser.add_argument("--candidate", type=Path, required=True, help="Saved m4-int8-precise-core-full14-001/model.onnx")
    ...
    plan = {"schema": "latency58-native-cpu1-comparison-v1", "source_bindings": bindings,
            ...
            "candidate_precision": "U8U8 projections; FP64 quantizer ancestors; FP32 decoding and public state"}
