"""Train two-second scored contexts with a B16 objective accumulated over four B4 microbatches."""
...
def main():
    ...
    if stage["resource_only"]:
        from research.direct.check_latency58_branch_long_context_gpu_b4 import check_gpu
