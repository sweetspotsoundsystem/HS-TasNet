...
def metadata(plan, model, step, fingerprint, shapes):
    from research.direct.latency58 import VERSION, Latency58State

    return {
        "hs_tasnet.kind": "cropped1024_hop128", "hs_tasnet.mode": "streaming",
        ...
        "hs_tasnet.state_names": json.dumps(Latency58State._fields), "hs_tasnet.state_shapes": json.dumps(shapes),
        ...
        "hs_tasnet.model_source_sha256": sha(ROOT / "research/direct/latency58.py"),
        "hs_tasnet.export_copy_source_sha256": sha(ROOT / "research/direct/latency58_onnx.py"),
...
def main():
    ...
    require(plan["schema"] == "latency58-onnx-export-plan-v1" and Path.cwd() == ROOT,
            "Export schema or working directory differs")
    bindings = plan["source_bindings"]
    for relative in ("research/direct/export_latency58.py", "research/direct/latency58.py",
                     "research/direct/latency58_checkpoint.py", "research/direct/latency58_evaluate.py",
                     "research/direct/latency58_onnx.py", "export_onnx.py"):
    ...
    from research.direct.latency58_onnx import (
    ...
    report = {"schema": "latency58-onnx-verification-v1", "plan_sha256": args.plan_sha256,
