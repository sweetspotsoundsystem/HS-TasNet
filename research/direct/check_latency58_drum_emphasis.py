"""Qualify a prospective drum-weighted objective on the real unchanged model."""
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-drum-emphasis-functional-plan-v1"
    ...
    verify_inputs(plan)
    result = {"schema": "latency58-drum-emphasis-functional-result-v1", "status": "pass",
