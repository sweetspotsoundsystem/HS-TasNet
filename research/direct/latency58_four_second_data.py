"""Six-second crops for four-second scoring with qualified pitch/tempo and B16 remixes.

Only crop geometry changes: 88,064 warmup samples plus 176,512 scored samples.
...
def policy():
    return {**parent_policy(), "version": "latency58-four-second-score-pitch-tempo-remix-v1",
