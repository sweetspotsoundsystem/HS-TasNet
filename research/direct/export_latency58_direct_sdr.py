"""Export a verified 5 dB direct-SDR checkpoint with unchanged recurrent parity checks."""
...
def run(plan_path, plan_sha):
    ...
    from research.direct.latency58_direct_sdr_checkpoint import SCHEMA, load_model
    ...
    from research.direct.export_latency58_direct_sdr_metadata import metadata
...
def main():
    ...
    paths = [Path(__file__).resolve(), ROOT / "research/direct/export_latency58_direct_sdr_metadata.py",
    ...
    execute([PYTHON, "-u", "-m", "research.direct.export_latency58_direct_sdr", "--plan", str(out / "plan.json"),
