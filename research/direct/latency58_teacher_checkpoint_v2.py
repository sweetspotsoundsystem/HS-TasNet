...
def load_model_state(model, checkpoint):
    ...
    require(payload["schema"] == "latency58-teacher-inference-v2" and type(payload["step"]) is int
            ...
            and provenance["training_plan_sha256"] == payload["plan_sha256"]
            ...
            and provenance["parent_provenance"]["asymmetric_training_updates"] == 500
            and provenance["parent_provenance"]["pilot_updates"] == 2500
            and provenance["initialized_model_state_sha256"] == provenance["parent_model_state_sha256"],
            "Trial lineage or architecture differs")
