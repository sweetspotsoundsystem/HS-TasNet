"""Run preserved bass probes through an audited drum-weighted context generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-sdr-drum-probe-plan-v2"
    ...
    from research.direct.evaluate_latency58_sdr_drum_v2 import load_evaluation_model
    ...
    report = {"schema": "latency58-sdr-drum-probe-result-v2", "status": "pass", "checkpoint": plan["checkpoint"],
