"""Score an audited latency58_reduced_teacher generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_reduced_teacher_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-reduced-teacher-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "latency58_reduced_teacher_trial_updates": receipt["step"], "provenance": model.provenance,
