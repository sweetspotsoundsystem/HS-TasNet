...
HERE = Path(__file__).resolve().parents[2] / "research/direct/runs/latency11/smoke/gpu-crash-followup"
...
GPU_READER_SOURCE = HERE.parents[3] / "latency58_nvml_guard_reader.py"
...
GPU_BINDINGS = {
    ...
    str(GPU_READER_SOURCE): "d1d236cafc36a92f6faa6869176bd4d85ec273fb0f6cc92b794d53d0dfaffaed",
...
def main():
    ...
    require(out.parent == Path(__file__).resolve().parents[1] / "four_second_20260916/monitors"
            and not out.exists(), "Use a new direct child result directory in the allocated monitor root")
    out.mkdir()
