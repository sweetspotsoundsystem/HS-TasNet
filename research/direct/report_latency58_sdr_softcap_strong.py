"""Compare a stronger soft-capped SDR candidate with its parent and working baseline."""
...
def main():
    ...
    require(training["schema"] == "latency58-sdr-softcap-strong-training-v1", "Unknown relative-error training plan")
    ...
    if args.matched_prefix:
        ...
        require(match["schema"] == "latency58-softcap-weight-matched-batches-v1"
                ...
                and match["different_trained_model_states"]["strong"] == states["full14"]
        ...
        for mode in ("full14", "actions60", "probes"):
            ...
            require(reference_state == match["different_trained_model_states"]["small"],
    ...
    report = {
        "schema": "latency58-sdr-softcap-strong-quality-summary-v1", "prefix": args.prefix, "step": plans["full14"]["step"],
        ...
        "limitations": ["Primary development-panel results; confirmation intervals remain outside selection.",
                        ...
                        "The matched 250-update recipes change only the auxiliary coefficient, with one augmentation seed.",
