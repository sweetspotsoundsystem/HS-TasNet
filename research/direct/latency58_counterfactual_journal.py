"""Record and independently check which examples contribute to distillation."""
...
def validate_microbatch(micro, mode):
    ...
    require(len(codes) == 4 and sorted(codes) == [0, 1, 2, 3]
    ...
    # FP32 reductions differ slightly in order, but a B=2 divisor must fail.
