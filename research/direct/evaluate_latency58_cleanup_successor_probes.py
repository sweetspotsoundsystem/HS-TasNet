"""Run preserved bass probes through an audited cleanup_successor generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-cleanup-successor-probe-plan-v1"
    ...
    report = {"schema": "latency58-cleanup-successor-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
