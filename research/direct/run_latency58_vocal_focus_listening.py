...
def main():
    ...
    sources = {str(path): sha(path) for path in (
        Path(__file__).resolve(), ROOT / "research/direct/prepare_latency58_vocal_focus_listening.py",
    ...
    execute([PYTHON, "-u", "-m", "research.direct.prepare_latency58_vocal_focus_listening",
