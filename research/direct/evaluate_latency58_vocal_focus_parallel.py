...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-vocal-focus-parallel-music-plan-v1" and plan["workers"] == 2
            and plan["model_kind"] == "vocal_focus_candidate", "Unsupported parallel evaluation")
