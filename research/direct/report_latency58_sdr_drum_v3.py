"""Compare a drum-weighted context candidate with its parent and working baseline."""
...
def main():
    ...
    require(training["schema"] == "latency58-sdr-drum-training-v3", "Unknown drum-weighted training plan")
    ...
    for mode in ("full14", "actions60", "probes"):
        ...
        require(parent_state == training["parent"]["model_state_sha256"], "Different parent in drum-weighted comparison")
    ...
    report = {
        "schema": "latency58-sdr-drum-quality-summary-v3", "prefix": args.prefix, "step": plans["full14"]["step"],
        ...
        "limitations": ["Primary development-panel results; confirmation intervals remain outside selection.",
                        "No matched unweighted update control; changes cannot be attributed solely to drum weighting.",
