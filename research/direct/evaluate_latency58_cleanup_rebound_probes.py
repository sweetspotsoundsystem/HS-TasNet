"""Run preserved bass probes through an audited cleanup_rebound generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-cleanup-rebound-probe-plan-v1"
    ...
    report = {"schema": "latency58-cleanup-rebound-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
