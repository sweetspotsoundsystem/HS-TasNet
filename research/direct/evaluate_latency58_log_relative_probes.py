"""Run preserved bass probes through an audited weak relative-error generation.
...
def main():
    ...
    require(plan["schema"] == "latency58-log-relative-probe-plan-v1"
    ...
    report = {"schema": "latency58-log-relative-probe-result-v1", "status": "pass", "checkpoint": plan["checkpoint"],
