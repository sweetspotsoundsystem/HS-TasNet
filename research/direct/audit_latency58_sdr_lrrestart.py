...
def main():
    ...
    from research.direct.latency58_sdr_lrrestart_checkpoint import load_model, read_generation, validate_journal
    ...
    result = {"schema": "latency58-sdr-lrrestart-audit-v1", "status": "pass", "step": step,
