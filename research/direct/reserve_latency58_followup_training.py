...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-followup-training-storage-plan-v1"
            and plan["steps"] == [700, 725]
