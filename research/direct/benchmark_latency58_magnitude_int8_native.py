"""Compare saved C204 FP32 and full-magnitude precise U8U8 graphs with the plugin's native ORT 1.26 CPU SDK.
...
CANDIDATE_SHA = "291b32f4d47aa446913edf93d46d121e58d223bb3949de8b3b8303e528cc9faf"
...
def main():
    ...
    parser.add_argument("--candidate", type=Path, required=True, help="Saved m4-magnitude-int8-full14-001/model.onnx")
