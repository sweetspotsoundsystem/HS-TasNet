"""Audit a complete vocal-focus pilot's model, Adam state, RNG and matched journal."""
...
def main():
    ...
    from research.direct.latency58_vocal_focus_checkpoint import load_model, read_generation, validate_journal, validate_recipe
    ...
    result = {"schema": "latency58-vocal-focus-audit-v1", "status": "pass", "step": step,
