"""Create one inference snapshot from a separately audited hop128 resume.
...
def main():
    ...
    require(plan["schema"] == "latency58-snapshot-plan-v1"
    ...
    payload = {"schema": "latency58-inference-v1", "step": step, "model": model.state_dict(),
