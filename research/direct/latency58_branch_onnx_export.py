...
def metadata(model, payload, training, checkpoint, quality_path):
    ...
    values = {
        ...
        "current_stage_augmentation": json.dumps(training["config"]["augmentation"], sort_keys=True),
        ...
        "checkpoint_weight_role": payload["provenance"]["checkpoint_weight_role"],
        "weight_averaging": json.dumps(payload["provenance"]["weight_averaging"], sort_keys=True),
        ...
        "export_copy_source_sha256": sha(ROOT / "research/direct/latency58_branch_onnx.py"),
