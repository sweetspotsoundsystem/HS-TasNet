"""Score an audited cleanup_followup generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_cleanup_followup_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-cleanup-followup-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "cleanup_followup_trial_updates": receipt["step"], "provenance": model.provenance,
