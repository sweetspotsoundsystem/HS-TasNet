"""Check canonical accumulation against an independent whole-group VJP.
...
from research.direct.latency58_grouped_vocal_canonical import accumulate_groups, policy as accumulation_policy
...
def check_restart(parent, plan, *, progress=None):
    ...
    from research.direct.check_latency58_grouped_vocal_canonical_cpu import exercise
