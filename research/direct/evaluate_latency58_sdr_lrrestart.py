"""Score an audited higher-LR context generation with the preserved streamer."""
...
def load_evaluation_model(plan):
    from research.direct.latency58_sdr_lrrestart_checkpoint import load_model
...
def main():
    ...
    plan = read(args.plan)
    require(plan["schema"] == "latency58-sdr-lrrestart-music-plan-v1"
    ...
    identity = {"label": plan["label"], "state_kind": "checkpoint",
                ...
                "lr_restart_trial_updates": receipt["step"], "provenance": model.provenance,
